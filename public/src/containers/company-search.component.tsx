...
type TCountry = { country: string; continent: string };
...
const CompanySearch = (): React.ReactElement => {
  const getOptionLabel = get<TCountry, 'country'>('country');
  const renderInput = React.useCallback(
    (params: AutocompleteRenderInputParams): React.ReactElement => <TextField {...params} label="Combo box" variant="outlined" />,
    []
  );
  return <Autocomplete<TCountry> renderInput={renderInput} options={countries} getOptionLabel={getOptionLabel} />;
};
